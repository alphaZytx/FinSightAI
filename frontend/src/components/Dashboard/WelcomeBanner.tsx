...
export default function WelcomeBanner({ userName = 'Alex' }: WelcomeBannerProps) {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-border bg-gradient-to-br from-banner-from via-banner-via to-banner-to p-6 md:p-8">
      ...
      <div className="relative flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <p className="text-sm text-primary-500">{formatDate()}</p>
